...
<!-- AdminLTE App -->
<script src="{{ asset('admins/plugins/dist/js/adminlte.js') }}"></script>
<script src="{{ asset('admins/plugins/dist/js/demo.js') }}"></script>
<script src="{{ asset('admins/plugins/dist/js/pages/dashboard.js') }}"></script>
